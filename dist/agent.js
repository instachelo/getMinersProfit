...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    var findings, block, gasPrice, gasUsed;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                findings = [];
                if (!(txEvent.block.number !== current_block)) return [3 /*break*/, 2];
                if (miner !== "") {
                ...
                return [4 /*yield*/, web3.eth.getBlock(txEvent.block.number)];
            case 1:
                block = _a.sent();
                miner = block.miner;
                current_block = txEvent.block.number;
                profit_sum = 0;
                _a.label = 2;
            case 2:
                gasPrice = parseInt(txEvent.transaction.gasPrice, 16) / 100000000;
                gasPrice = gasPrice / 10000000000;
                gasUsed = parseInt(txEvent.transaction.gas, 16);
                profit_sum = profit_sum + (gasUsed * gasPrice);
